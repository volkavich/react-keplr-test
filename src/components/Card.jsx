...
function Card() {
  return (
    <div className="flex justify-center h-screen items-center">
      <div className=" bg-green-600/10  shadow-green-700/50 flex backdrop-blur-lg shadow-2xl  flex-col text-center justify-between rounded-lg border border-white/20  h-60 p-6 w-max">
